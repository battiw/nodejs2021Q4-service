...
const putBoardServis = (idBoardPut: string, createBorderPut: IBoard) => putBoardMemory(idBoardPut, createBorderPut);
const deleteBoardServis = (idBoardDelete: string) => deleteBoardMemory(idBoardDelete);
